...
A **statement** or a **proposition** is something that is either true or false. A proposition creates a **distinction**: a 'crisp' yes/no question about the world. A proposition at a specific point in time defines an _event_. (Use the proposition $G$ to label the event.) ![Image Description]([https://githubusercontent.com](https://raw.githubusercontent.com/stanford-msande152/summer26/refs/heads/main/lit/manuscript/Figure1-01_bis.svg))
