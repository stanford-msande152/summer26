...
Ethical questions that arise in Decision Analysis

## Class schedule
- What is Ethics, ethics in professional practice
- Decision Analyis and ethics
- Winding up the class. 
...
(Movie, ["Do the RIght Thing"](https://www.imdb.com/title/tt0097216/1989), Spike Lee, 1989)
...
Stoicism is a branch of Greco-Roman philosophy that sees ethics as an aspect of personal virtue.  Its notion of a life well lived is to live in agreement with our nature. Particular to our human nature is "the ability to reason and the fact that we are highly social." ( Pigliucci & Lopez, p. 84) From these follow four principal virtues: Wisdom, Temperance, Courage and Justice, . Let's interpret these in turn, in current Decision Analysis terms, to see how it matches up. 
...
- **Temperance**. (Moderation) Matching one’s actions to the situation at hand.  Here Decision Analysis is a major advance over classical thinking, specifically Aristotle's notion of that an ethical action sits at the mean between extremes.  He gives an example from medicine and health. To paraphrase -- what is appropriate is destroyed by either deficiency or excess as in the case exercise or nutrition, however proportionate amounts create and preserve health. (my version NIchomachean Ethics Book 2, Ch 3, 1104a15.) The ancients did not have the benefit of quantifiable probability that was only developed relatively recently, by which Aristotle's idea of "proportionate" action is made precise. 
...
In short, our notion of a good decision partly matches what a Stoic philosopher regards as ethical. Decision analysis can be called "prudent", it guides one in being prudent.  In Stoic thought any action has to respect all virtues to be ethical. Decision analysis contributes the prudent part. However since the Stoic requires a good action to incorporate all virtues, to be ethical we need to extend the idea of a Good Decision, specifically to consider how an action affects other people. 



## Class Activity

**Please take the class evaluation survey**

Class presentations here, tomorrow from 2 to 4 PM. [Sign up on this spreadsheet.](https://docs.google.com/spreadsheets/d/11Iam7x3MMNfW7Kn9Z4-9wXblrDK23HkNZqihbqPTeqk/edit?usp=sharing)
Presenters - send me your slides ( powerpoint or pdf) so we can show them from my machine. 
...
Good
Ethical, moral
Stoic Virtue:  Wisdom, Temperance, Courage, Justice
Prudence

## Files, references

- R.C. Bartlett, S.D. Collins (2011) translators, "Aristotle's Nicomachean Ethics" , U. of Chicago Press. 
- R. Howard, C. Korver ( 2008) "Ethics for the Real World" Harvard Business Press, MA. 
- I. Murdoch (1970) "The Sovereignty of Good" Routledge Classics, NY. 
- M. Pigliucci, G. Lopez (2025)"Beyond Stoicism" The Experiment LLC, NY. 


## Curious?  Things to explore 

Stanford Encyclopedia of Philosophy
https://altiorem.org/organisation/stanford-encyclopedia-of-philosophy
